...
import static org.hamcrest.Matchers.hasValue;
    ...
    public class StudentCURDTest extends TestBase {
        ...
        static String firstName = "Joshwa"+ TestUtils.getRandomValue();
        static String lastName = "james"+ TestUtils.getRandomValue();
        static String email = "josh23"+ TestUtils.getRandomValue()+ "@gmail.com";
